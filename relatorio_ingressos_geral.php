<?php
    ...
    //Carrega os dados
    $sql = "SELECT origem, COUNT(origem) as qtd FROM aluno GROUP BY origem";
        ...
        data.addRows([
          <?php
            foreach($items as $item){
                echo("['$item->origem', $item->qtd],");
            }
          ?>
        ]);

        // Set chart options
        var options = {'title':'Escola de origem dos alunos',
                       'width':900,
                       'height':600};
...
<main role="main" class="container" style="text-align:center;">
    <div class="card">
        <h4 class="card-header">Relatório de Ingressos - Geral</h4>
        <div class="card-body">
